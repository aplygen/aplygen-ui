            ...
            <CardContent className="p-6 space-y-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="email" value="vishwas@example.com" disabled className="bg-gray-50" />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-white">
                    ...
                    <Button variant="outline" size="sm" onClick={handleDisconnectGoogle} className="text-red-600 border-red-200 hover:bg-red-50">
                      Disconnect
                    </Button>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-white">
                    ...
                    <Button variant="outline" size="sm" onClick={handleDisconnectLinkedIn} className="text-red-600 border-red-200 hover:bg-red-50">
                      Disconnect
                    </Button>
                  </div>
                </div>
          ...
          <Card className="border-gray-200 shadow-sm">
            ...
            <CardContent className="p-6 space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="jobAlerts" className="text-gray-900">Job Alerts</Label>
                    <p className="text-sm text-gray-500">New job matches for your profile</p>
                  </div>
                  <Switch 
                    id="jobAlerts"
                    checked={jobAlerts}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="applicationUpdates" className="text-gray-900">Application Updates</Label>
